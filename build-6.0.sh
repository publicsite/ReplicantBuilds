...
##build sources
. build/envsetup.sh
lunch replicant_${thedevice}-userdebug
...
if [ -d "out/target/product/${thedevice}/obj/KERNEL_OBJ" ]; then
rm -rf out/target/product/${thedevice}/obj/KERNEL_OBJ
fi
...
#to sign the images
#./vendor/replicant/sign-build ${thedevice}
